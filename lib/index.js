...
DCP.editChannelPermissions = function(input, callback) { //Will shrink this up later
	...
	allowed_values = [0, 4, 28];
	if (channel.type === 'text' || channel.type === 0 || channel.type === 4) allowed_values = allowed_values.concat([10, 11, 12, 13, 14, 15, 16, 17, 18]);
	if (channel.type === 'voice' || channel.type === 2 || channel.type === 4) allowed_values = allowed_values.concat([20, 21, 22, 23, 24, 25]);
